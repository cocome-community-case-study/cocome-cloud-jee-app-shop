...
(function (ons) {
  ...
  function initOnsenFacade() {
     ...
     * @return {Object}
     *   [en]UiComponent object. Will return null if no component was found.[/en]
 ...
 * @category menu
 * @description
 *   [en]UiComponent for sliding UI where one page is overlayed over another page. The above page can be slided aside to reveal the page behind.[/en]
