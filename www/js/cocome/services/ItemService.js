...
define(["require", "exports", "../../framework/Service", "../types/Item", "../Settings"], function (require, exports, Service_1, Item_1, Settings_1) {
    "use strict";
    var ItemService = (function (_super) {
        ...
        function ItemService() {
            ...
            _this._items = [];
            _this.allItems = function (store) {
                var result = new Array();
                $.ajax({
                    url: Settings_1.Settings.url + "/api/items/",
                    async: false,
                    dataType: "json",
                    type: "get",
                    data: {
            ...
            _this.querryItems = function (store, query) {
                var result = new Array();
                $.ajax({
                    url: Settings_1.Settings.url + "/api/items/query",
                    async: false,
                    dataType: "json",
                    type: "get",
                    data: {
        ...
        ItemService.prototype.getItemById = function (store, itemId) {
            var item = null;
            $.ajax({
                url: Settings_1.Settings.url + "/api/items/id",
                async: false,
                dataType: "json",
                type: "get",
                data: {
